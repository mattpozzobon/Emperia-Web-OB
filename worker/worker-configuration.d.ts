/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker/worker-configuration.d.ts` (hash: 9c02e06ff8be6d0796586b3e2606f004)
// Runtime types generated with workerd@1.20260722.1 2026-07-26 nodejs_compat
interface __BaseEnv_Env {
	ALLOWED_ORIGINS: "http://localhost:5173";
	GOOGLE_TRANSLATE_API_KEY: string;
	TRANSLATION_ACCESS_TOKEN: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGINS" | "GOOGLE_TRANSLATE_API_KEY" | "TRANSLATION_ACCESS_TOKEN">> {}
}
